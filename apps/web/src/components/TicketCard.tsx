...
export default function TicketCard({ ticket }: { ticket: Ticket }) {
    ...
    const handleResaleConfirm = (price: number) => {
    ...
    return (
        <>
            <div className="relative w-full h-[400px] perspective-1000 group cursor-pointer" onClick={() => !isResaleModalOpen && setFlipped(!flipped)}>
                <motion.div
                    ...
                    >
                        ...
                        <div className="flex gap-2 w-full mt-2">
                            <button
                                ...
                                className="flex-1 p-2 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-600 text-xs font-bold transition-colors"
                            >
                            ...
                            {ticket.status === 'valid' && (
                                <button
                                    ...
                                    className="flex-1 p-2 rounded-xl bg-velo-bg-deep text-white hover:bg-black transition-colors text-xs font-bold"
                                >
                        ...
                        <div className="text-[10px] text-gray-400 mt-2">Powered by Velo SecureEntry™</div>
                    </div>
                </motion.div>
            </div>
            ...
            <ResaleModal
                ...
                ticket={{
                    ...
                    original_price: 150, // Mock original price for now
                    seat_info: ticket.seat_info
                }}
                onConfirmListing={handleResaleConfirm}
            />
        </>
    );
}
